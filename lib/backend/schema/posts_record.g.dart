    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'tagged_users':
          ...
          break;
        case 'post_prompt':
          result.postPrompt = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String?;
          break;
...
class _$PostsRecord extends PostsRecord {
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, postPrompt.hashCode);
...
class PostsRecordBuilder implements Builder<PostsRecord, PostsRecordBuilder> {
  ...
  String? _postPrompt;
  String? get postPrompt => _$this._postPrompt;
  set postPrompt(String? postPrompt) => _$this._postPrompt = postPrompt;
